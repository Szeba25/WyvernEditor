...
import com.szeba.wyv.widgets.ext.textfield.DoubleField;

public class DynDoubleField extends DoubleField implements Dynamic {

	private String receiver;
	
	public DynDoubleField(int ox, int oy, int rx, int ry, int w, String mode, int max) {

...
public class DynHolderDBEntry extends HolderDBEntry implements Dynamic {

	private String receiver;
	
	public DynHolderDBEntry(int ox, int oy, int rx, int ry, int w, int h) {
